...
# C1 improves with time, increases with comorbidies, improves if treated with antibiotics at time 0
...
# If C1<=1.5 -> Stop treatment i.e. A1=0,A2=0, and
# If C2<=2.5 -> Stop treamtment i.e. A2=0
# Y depends on C1, A1, C2, A2
# Y = 2 + 0.6*C1 - |C1 - 1.5|*{1(C1 - 1.5 > 0) - A1}^2 - A1*|C2 - 2.5|*{1(C2 - 2.5 > 0) - A2}^2
mu_Y = 2 + 0.6 * C1 - abs(C1-1.5) * (ifelse((C1-1.5)>0,1,0) - A1)**2 - A1 * abs(C2-2.5) * (ifelse(C2-2.5>0,1,0) - A2)**2
Y = rnorm(n, mu_Y, 0.1)
